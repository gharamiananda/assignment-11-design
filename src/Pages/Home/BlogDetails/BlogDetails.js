        ...
        <div>
            ...
            <div className="wrapper">
                ...
                <section className="section kf-started-inner">
                    <div className="kf-parallax-bg js-parallax" style={{ backgroundImage: "url(images/blog_inner_bg.jpg)" }}></div>
                        ...
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                                ...
                                <div className="kf-archive-items">
                                    ...
                                    <div className="kf-archive-item element-anim-1 scroll-animate" data-animate="active">
                                        ...
                                        <div className="desc">
                                            ...
                                            <div className="readmore">
                                                <a href="blog-single.html" className="kf-btn-link">
                                                    <span>read more</span>
                                ...
                                {/* <!-- pager --> */}
                                <div className="pager element-anim-1 scroll-animate" data-animate="active">
                                    <a className="page-numbers prev" href="blog.html">
                                        <i className="fas fa-chevron-left"></i>
                                    </a>
                                    <span className="page-numbers current">1</span>
                                    <a className="page-numbers" href="blog.html">2</a>
                                    <a className="page-numbers" href="blog.html">3</a>
                                    <span className="page-numbers dots">&hellip;</span>
                                    <a className="page-numbers" href="blog.html">9</a>
                                    <a className="page-numbers next" href="blog.html">
                                        <i className="fas fa-chevron-right"></i>
                                    </a>
                                </div>
                                ...
                                <div className="col__sedebar scrolla-element-anim-1 scroll-animate" data-animate="active">
                                    <div className="content-sidebar">
                                        <aside className="widget-area">
                                            ...
                                            <div className="widget widget_search element-anim-1 scroll-animate" data-animate="active">
                                                <form className="wp-block-search">
                                                    <input type="search" className="wp-block-search__input" placeholder="Search" value="" />
                                                    <button type="submit" className="wp-block-search__button">Search</button>
                                                </form>
                                            </div>

                                            <section className="widget widget_categories element-anim-1 scroll-animate" data-animate="active">
                                            ...
                                            <section className="widget widget_recent_entries element-anim-1 scroll-animate" data-animate="active">
                                            ...
                                            <section className="widget widget_tag_cloud element-anim-1 scroll-animate" data-animate="active">
                                                <h5 className="widget-title">Tag Cloud</h5>
                                                <div className="tagcloud">
                                                    <a href="#" className="tag-cloud-link">html</a>
                                                    <a href="#" className="tag-cloud-link">photo</a>
                                                    <a href="#" className="tag-cloud-link">food</a>
                                                    <a href="#" className="tag-cloud-link">chat</a>
                                                    <a href="#" className="tag-cloud-link">fashion</a>
                                                    <a href="#" className="tag-cloud-link">css</a>
                                                    <a href="#" className="tag-cloud-link">embeds</a>
                                                    <a href="#" className="tag-cloud-link">portfolio</a>
                                                    <a href="#" className="tag-cloud-link">personal</a>
                                                    <a href="#" className="tag-cloud-link">js</a>
                                                </div>
                                            </section>

                                            <section className="widget widget_archive element-anim-1 scroll-animate">
                                            ...
                                            <section className="widget widget_recent_comments element-anim-1 scroll-animate" data-animate="active">
                                                <h5 className="widget-title">Recent Comments</h5>
                                                <ul>
                                                    <li className="recentcomments">
                                                        <span className="comment-author-link">
                                                            <a href="#" className="url">John Doe</a>
                                                    ...
                                                    <li className="recentcomments">
                                                        <span className="comment-author-link">
                                                            <a href="#" className="url">James Flick</a>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4 align-self-center align-right">
                                ...
                                <a href="reservation.html" className="kf-btn element-anim-1 scroll-animate" data-animate="active">
                    ...
                    <div className="container">
                        ...
                        <div className="kf-brands-items row">
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
                                <div className="kf-brands-item element-anim-1 scroll-animate" data-animate="active">
                                    <div className="image">
